...
- Fixed scheduled close command from not closing threads.
...
- Fix `?selfcontact` command saying user is blocked.
- Fix `?msglink` command not finding message from other recipients. [(#3341)](https://github.com/modmail-dev/Modmail/pull/3341)
